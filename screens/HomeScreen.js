...
export default class HomeScreen extends React.Component{
  ...
  componentDidMount = async() => {
    ...
    var class_ref =await db.ref('mySchool').on('value', data => {
      ...
      // set all_students to the state property all_students }
...
// change styles as per your preference
